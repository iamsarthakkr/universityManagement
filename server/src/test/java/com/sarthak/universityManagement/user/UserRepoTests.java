...
class UserRepoTests {
    ...
    void shouldSaveUserSuccessfully() {
        UserEntity user = TestDataFactory.user("alice", "alice@example.com", Role.STUDENT);
    ...
    void shouldFindUserByUsername() {
        String username = "bob";
        UserEntity user = TestDataFactory.user(username, "bob@example.com", Role.STUDENT);
    ...
    void shouldReturnTrueWhenUsernameExists() {
        ...
        UserEntity user = TestDataFactory.user(username, "carol@example.com", Role.STUDENT);
        userRepo.saveAndFlush(user);
    ...
    void shouldReturnTrueWhenEmailExists() {
        ...
        UserEntity user = TestDataFactory.user("frank", email, Role.STUDENT);
        userRepo.saveAndFlush(user);
    ...
    void shouldRejectDuplicateUsername() {
        ...
        UserEntity first = TestDataFactory.user(username, "dave1@example.com", Role.STUDENT);
        userRepo.saveAndFlush(first);
        
        UserEntity duplicate = TestDataFactory.user(username, "dave2@example.com", Role.STUDENT);
    ...
    void shouldRejectDuplicateEmail() {
        ...
        UserEntity first = TestDataFactory.user("erin1", email, Role.STUDENT);
        userRepo.saveAndFlush(first);
        
        UserEntity duplicate = TestDataFactory.user("erin2", email, Role.STUDENT);
        assertThrows(DataIntegrityViolationException.class, () -> userRepo.saveAndFlush(duplicate),
    ...
    void shouldPersistUserRole() {
        ...
        UserEntity user = TestDataFactory.user("greg", "greg@example.com", role);
    ...
    void shouldRejectNullUsername() {
        UserEntity u = TestDataFactory.user("temp", "temp@example.com", Role.STUDENT);
        u.setUsername(null);
    ...
    void shouldRejectNullEmail() {
        UserEntity u = TestDataFactory.user("temp2", "temp2@example.com", Role.STUDENT);
        u.setEmail(null);
        assertThrows(DataIntegrityViolationException.class, () -> userRepo.saveAndFlush(u));
    }
    ...
    void shouldRejectNullPassword() {
        UserEntity u = TestDataFactory.user("temp3", "temp3@example.com", Role.STUDENT);
        u.setPassword(null);
        assertThrows(DataIntegrityViolationException.class, () -> userRepo.saveAndFlush(u));
    }
    ...
    void shouldRejectNullRole() {
        UserEntity u = TestDataFactory.user("temp4", "temp4@example.com", Role.STUDENT);
        u.setRole(null);
        assertThrows(DataIntegrityViolationException.class, () -> userRepo.saveAndFlush(u));
    }
    ...
    void shouldPopulateCreatedAtBeforeNow() {
        UserEntity user = TestDataFactory.user("audit1", "audit1@example.com", Role.STUDENT);
        UserEntity saved = userRepo.saveAndFlush(user);
    ...
    void shouldPopulateUpdatedAtBeforeNow() {
        UserEntity user = TestDataFactory.user("audit2", "audit2@example.com", Role.STUDENT);
        UserEntity saved = userRepo.saveAndFlush(user);
